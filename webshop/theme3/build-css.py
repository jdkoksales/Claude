...
TAIL = ("html{scroll-behavior:smooth}\n"
        ...
        ".tk3-bijverkoop-knop[hidden],.tk3-kies[hidden]{display:none!important}\n"
        # Kiezen welke kaart erbij komt. Ligt over de lade heen en niet erin,
        # zodat de artikelenlijst er geen hoogte aan kwijtraakt — dat was
        # precies het probleem dat we net hebben verholpen.
        ".tk3-kies{position:absolute;inset:0;z-index:6;display:flex;flex-direction:column;"
        ...
        "border-radius:50%;background:#fff;font-size:20px;line-height:1;color:#1A202C;cursor:pointer}\n"
        ".tk3-kies-uitleg{margin:0 0 14px;font-size:13px;line-height:1.45;color:rgba(0,0,0,.6)}\n"
        ".tk3-kies-lijst{list-style:none;margin:0;padding:0;overflow-y:auto;flex:1 1 auto}\n"
        ".tk3-kies-lijst li{margin:0 0 8px}\n"
        ".tk3-kies-item{display:flex;align-items:center;gap:12px;width:100%;padding:9px 11px;"
        "border:1px solid rgba(0,0,0,.12);border-radius:12px;background:#fff;cursor:pointer;text-align:left;"
        "transition:border-color .15s,background .15s}\n"
        ".tk3-kies-item:hover{border-color:#1A202C;background:rgba(0,0,0,.02)}\n"
        ".tk3-kies-item[disabled]{opacity:.6;cursor:default}\n"
        ".tk3-kies-item img{width:44px;height:44px;object-fit:contain;border-radius:8px;"
        "background:rgba(0,0,0,.04);flex:0 0 auto}\n"
        ".tk3-kies-naam{flex:1 1 auto;min-width:0;font-size:13.5px;font-weight:650;color:#1A202C;line-height:1.3}\n"
        ".tk3-kies-prijs{flex:0 0 auto;font-size:13.5px;font-weight:750;color:#1A202C}\n"
